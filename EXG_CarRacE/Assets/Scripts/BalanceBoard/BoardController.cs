...
public class BoardController : MonoBehaviour {
    ...
    [SerializeField] private BB_Quadrant bbRaw;
    [SerializeField] private Vector2 bbCenter;
    ...
    private void StandingCalibration() {
        ...
        if (countTimer[0] > 0.0f) {
            slider.GetComponent<RadialSlider>().SliderValue =
                (((currentTimer[0] - startTimer[0]) / duration) * 100);
